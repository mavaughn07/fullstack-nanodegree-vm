...
item4 = Item(name="Snowpants", description="Ski pants, or salopettes, when part of a two-piece ski suit, is usually made in the same fabric and color as the corresponding ski jacket. It is sometimes in the form of bib-and-brace and the jacket is worn over it.",
					 category=category1)
...
item1 = Item(name="Soccer Ball", description="A football, soccer ball, or association football ball is the ball used in the sport of association football. The name of the ball varies according to whether the sport is called 'football', 'soccer', or 'association football'. The ball's spherical shape, as well as its size, weight, and material composition, are specified by Law 2 of the Laws of the Game maintained by the International Football Association Board. Additional, more stringent, standards are specified by FIFA and subordinate governing bodies for the balls used in the competitions they sanction.",
					 category=category2)
...
item2 = Item(
	name="Cleats", description="Cleats or studs are protrusions on the sole of a shoe, or on an external attachment to a shoe, that provide additional traction on a soft or slippery surface. They can be conical or blade-like in shape, and made of plastic, rubber or metal. The type worn depends on the environment of play, whether it be grass, ice, artificial turf, or other grounds.", category=category2)

session.add(item2)
session.commit()

item3 = Item(name="Goalie Gloves", description="There are no other specific requirements, but goalkeepers are usually allowed to wear additional protective gear such as padded clothing. Most goalkeepers also wear gloves to protect their hands and enhance their grip of the ball.",
					 category=category2)

session.add(item3)
session.commit()

item4 = Item(name="Shinguards", description="A shin guard or shin pad is a piece of equipment worn on the front of a player’s shin to protect them from injury. These are commonly used in sports including association football, baseball, ice hockey, field hockey, lacrosse, cricket, mountain bike trials, and other sports. This is due to either being required by the rules/laws of the sport or worn voluntarily by the participants for protective measures.",
					 category=category2)
...
item2 = Item(name="Mitt", description="A baseball glove or mitt is a large leather glove worn by baseball players of the defending team, which assists players in catching and fielding balls hit by a batter or thrown by a teammate. By convention, the glove is described by the handedness of the intended wearer, rather than the hand on which the glove is worn: a glove that fits on the left hand—used by a right-handed thrower—is called a right-handed(RH) or 'right-hand throw' (RHT) glove. Conversely, a left-handed glove(LH or LHT) is worn on the right hand, allowing the player to throw the ball with the left hand.",
					 category=category1)
...
item1 = Item(name="Pads", description="Shoulder pads are a piece of protective equipment used in many contact sports such as American football, Canadian football, lacrosse and hockey. The first football shoulder pads were created by Princeton student L.P. Smock in 1877. These were made of leather and wool and were thin, light, and did not provide much protection. Additionally, they were sewn into the players' jerseys rather than being worn as a separate piece of equipment.  Allegedly Pop Warner was the first to have his players wear shoulder pads. When he was coaching at the Carlisle Indian Industrial School, he was the first one to use pads made of fiber rather than cotton.",
					 category=category1)
